        ...
        if (err) {
            throw err;
               ...
               //console.log('results: %j', results);
                ...
                var exec = pool.query('insert into label_'+num+'_neg set ?',data,function(err,rows){
                ...
                if (rows.insertId > MAX)
                    {
                        ...
                        var exec1 = pool.query('delete from label_'+num+'_neg where num ='+[rows.insertId - MAX],function(err1,rows1){
                            if (err)
                            {
                                console.log(err1);
                            }
